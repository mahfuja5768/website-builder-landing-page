...
const TopHeader = () => {
  ...
  return (
    <div>
      ...
      <div className="max-w-[760px] flex gap-6 items-center justify-between md:flex-row flex-col">
        {options.map((item) => (
          <li key={item} className=" list-none text-[13px] text-[#4B5665] bg-white w-[138px] rounded-lg h-[36px] flex justify-start ps-4 items-center">
            {item}
          </li>
        ))}
      </div>
      <div>
        <ul className="flex items-center gap-5 text-[#727D87] my-4 mt-7 text-sm">
            <li className="flex items-center gap-5">Home <img src={greaterImg} alt="greaterImg" /></li>
            <li className="flex items-center gap-5">Hosting for all <img src={greaterImg} alt="greaterImg" /></li>
            <li className="flex items-center gap-5">Hosting <img src={greaterImg} alt="greaterImg" /></li>
            <li className="flex items-center gap-5">Hosting6 <img src={greaterImg} alt="greaterImg" /></li>
